        ...
        match std::env::var(env_var_name) {
            ...
            Ok(_) => {
                ...
                bail!(
                    ...
                    env_var_name, env_var_name, self.model
                )
            }
            Err(_) => {
                // 环境变量不存在
...
mod tests {
    ...
    fn test_resolve_api_key_different_openai_models() {
        let openai_models = vec!["gpt-4", "gpt-4o", "gpt-3.5-turbo", "gpt-4-turbo", "gpt-4o-mini"];
    ...
    fn test_resolve_api_key_different_gemini_models() {
        let gemini_models = vec!["gemini-2.5-pro", "gemini-2.5-flash", "gemini-1.5-pro", "gemini-1.5-flash"];
